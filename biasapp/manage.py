...
from biasapp.app import create_app
from biasapp.database import db
from biasapp.settings import DevConfig, ProdConfig
from biasapp.user.models import User

CONFIG = ProdConfig if os.environ.get('BIASAPP_ENV') == 'prod' else DevConfig
