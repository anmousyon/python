...
class LinkedArray:
    ...
    def deleteSort(self, parent, c):
        ...
        if c.next:
            ...
            if c.next.data[left] < c.data[parent] and c.next.data[left] \
                != 0:
                temp = c.data[parent]
            ...
            elif c.next.data[right] < c.data[parent] \
                and c.next.data[right] != 0:
